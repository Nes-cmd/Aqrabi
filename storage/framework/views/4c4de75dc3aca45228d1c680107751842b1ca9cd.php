...
<?php endif; ?>
    ...
    <form wire:submit.prevent="callMountedAction">
        ...
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.modal.index','data' => ['id' => 'page-action','wire:key' => $action ? $this->id . '.actions.' . $action->getName() . '.modal' : null,'xInit' => '
                $watch(\'isOpen\', () => {
                    if (isOpen) {
                        return
                    }
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'page-action','wire:key' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($action ? $this->id . '.actions.' . $action->getName() . '.modal' : null),'x-init' => '
                $watch(\'isOpen\', () => {
                    if (isOpen) {
                        return
                    }
...
<?php /**PATH /home/nesren/Project/web/laravel/Aqrabi-Ecommerce/vendor/filament/filament/src/../resources/views/components/page.blade.php ENDPATH**/ ?>