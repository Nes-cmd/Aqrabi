...
} elseif ($_instance->childHasBeenRendered('Q52y5s6')) {
    $componentId = $_instance->getRenderedChildComponentId('Q52y5s6');
    $componentTag = $_instance->getRenderedChildComponentTagName('Q52y5s6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Q52y5s6');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('Q52y5s6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('GYnJusl')) {
    $componentId = $_instance->getRenderedChildComponentId('GYnJusl');
    $componentTag = $_instance->getRenderedChildComponentTagName('GYnJusl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GYnJusl');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('GYnJusl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/nesren/Project/web/laravel/Aqrabi-Ecommerce/vendor/filament/filament/src/../resources/views/components/layouts/app.blade.php ENDPATH**/ ?>