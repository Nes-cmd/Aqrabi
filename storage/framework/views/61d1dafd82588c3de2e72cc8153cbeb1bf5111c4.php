...
} elseif ($_instance->childHasBeenRendered('mRQMyBn')) {
    $componentId = $_instance->getRenderedChildComponentId('mRQMyBn');
    $componentTag = $_instance->getRenderedChildComponentTagName('mRQMyBn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mRQMyBn');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('mRQMyBn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('jjaiXB6')) {
    $componentId = $_instance->getRenderedChildComponentId('jjaiXB6');
    $componentTag = $_instance->getRenderedChildComponentTagName('jjaiXB6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jjaiXB6');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('jjaiXB6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
