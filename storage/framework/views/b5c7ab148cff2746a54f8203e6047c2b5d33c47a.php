                                ...
                                <div class="table-responsive">
                                    <table class="table cart-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <button wire:click="removeWishlist(<?php echo e($wishlist->id); ?>)" class="product-remove"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
