...
} elseif ($_instance->childHasBeenRendered('zOLkGc5')) {
    $componentId = $_instance->getRenderedChildComponentId('zOLkGc5');
    $componentTag = $_instance->getRenderedChildComponentTagName('zOLkGc5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zOLkGc5');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('zOLkGc5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('VzVvHQ8')) {
    $componentId = $_instance->getRenderedChildComponentId('VzVvHQ8');
    $componentTag = $_instance->getRenderedChildComponentTagName('VzVvHQ8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VzVvHQ8');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('VzVvHQ8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
