...
} elseif ($_instance->childHasBeenRendered('EKyGtWy')) {
    $componentId = $_instance->getRenderedChildComponentId('EKyGtWy');
    $componentTag = $_instance->getRenderedChildComponentTagName('EKyGtWy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EKyGtWy');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('EKyGtWy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('8I0F8GB')) {
    $componentId = $_instance->getRenderedChildComponentId('8I0F8GB');
    $componentTag = $_instance->getRenderedChildComponentTagName('8I0F8GB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8I0F8GB');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('8I0F8GB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
