            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="block text-center">
                        ...
                        <a href="{{route('register-user','customer')}}" class="btn btn-dark mt-3 mx-2">Customer Account</a>
                        <a href="{{route('register-user','supplier')}}" class="btn btn-dark mt-3 mx-2">Supplier Account</a>
                    </div>
                </div>
            </div>
        </div>
