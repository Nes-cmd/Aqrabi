<nav class="navbar navbar-expand-lg navbar-light bg-white w-100" id="navbar">
  <a class="navbar-brand order-2 order-lg-1 col-md-2 text-center text-md-left" href="{{ route('shop.index') }}"><img height="45px" src="{{ asset('logo.svg')}}" alt="logo"></a>
    ...
    <div class="search-cart">
      ...
      <div class="search dropdown">
        <a class="hidden-arrow" href="#" id="navbarDropdownMenuAvatar" role="button" data-mdb-toggle="dropdown" aria-expanded="false">
          <img src="{{asset('customer/images/user.png')}}" class="rounded-circle" height="40" alt="Img" loading="lazy" />
        </a>
