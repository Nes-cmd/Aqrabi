            ...
            <div class="product text-center">
              <div class="product-thumb">
                ...
                <div class="product-hover-overlay">
                  ...
                  <a href="{{ route('shop.single-product', $product->id)}}" class="product-icon cart" data-toggle="tooltip" data-placement="left" title="" data-original-title="Details"><i class="ti-search"></i></a>
                </div>
              </div>
