    ...
    <div id="quickView" class="quickview">
        <div class="row w-100">
            ...
            <div class="col-lg-5 col-md-6 text-center text-md-left align-self-center pl-5">
                <h3 class="mb-lg-2 mb-2">{{ $product->name }}</h3>
                ...
                <div class="col-lg-6 mb-4 mb-lg-0">
                    ...
                    <div class="product-slider">
                        <div data-image="{{ asset($product->main_photo) }}">
                            <img class="img-fluid w-100 image-zoom" src="{{ asset('storage/'.$product->main_photo) }}" alt="product-img" data-zoom="{{ asset('storage/'.$product->main_photo) }}">
                        </div>
                        ...
                        <div data-image="{{ asset($product->photos[3]) }}">
                            <img class="img-fluid w-100 image-zoom" src="{{ asset('storage/'.$product->photos[3]) }}" alt="product-img" data-zoom="{{ asset('storage/'.$product->photos[3]) }}">
                        </div>
                        @endif
                    </div>
                </div>
