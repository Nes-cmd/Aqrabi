                    ...
                    function p() {
                        ...
                        return (
                            c.is(ct)
                                ? i ||
                                  ((n = a.list),
                                  D((t = f[o("fixedWidth")])) && ((t = G((n = F("div", { style: "width: " + t + "; position: absolute;" }, n))).width), H(n)),
                                  (i = (((t = t) && rn(G(a.track)[o("width")] / t)) || (f[o("autoWidth")] && c.length) || f.perPage) * (f.drag ? (f.flickMaxPages || 1) + 1 : 2)))
                                : (i = 0),
                            i
                        );
                    }
