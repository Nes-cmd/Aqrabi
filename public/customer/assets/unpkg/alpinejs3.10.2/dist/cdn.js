(() => {
    ...
    function _e(e, t) {
        typeof t == "function" ? (e._x_cleanups || (e._x_cleanups = []), e._x_cleanups.push(t)) : ((t = e), Lt.push(t));
    }
    function Kt(e) {
        $t.push(e);
    }
    ...
    function cn() {
        an(), et.disconnect(), (tt = !1);
    }
    var ee = [],
        nt = !1;
    function an() {
        (ee = ee.concat(et.takeRecords())),
            ee.length &&
                !nt &&
                ((nt = !0),
                queueMicrotask(() => {
    ...
    function Xe(e) {
        ...
        for (let o of r) if (!t.includes(o) && (Lt.forEach((s) => s(o)), o._x_cleanups)) for (; o._x_cleanups.length; ) o._x_cleanups.pop()();
        t.forEach((o) => {
            (o._x_ignoreSelf = !0), (o._x_ignore = !0);
        });
        for (let o of t) r.includes(o) || !o.isConnected || (delete o._x_ignoreSelf, delete o._x_ignore, Ft.forEach((s) => s(o)), (o._x_ignore = !0), (o._x_ignoreSelf = !0));
        t.forEach((o) => {
                        ...
                        if (i.hasOwnProperty(n)) {
                            ...
                            if ((o.get || o.set) && o.enumerable) {
                                let s = o.get,
                                    a = o.set,
                                    c = o;
                                (s = s && s.bind(t)), (a = a && a.bind(t)), s && (s._x_alreadyBound = !0), a && (a._x_alreadyBound = !0), Object.defineProperty(i, n, { ...c, get: s, set: a });
                            }
                            return !0;
                        }
                        return !1;
...
`
    ...
    function at(e) {
        let t = [],
            r = (a) => t.push(a),
            [n, i] = Dt(e);
        return t.push(i), [{ Alpine: I, effect: n, cleanup: r, evaluateLater: _.bind(_, e), evaluate: k.bind(k, e) }, () => t.forEach((a) => a())];
    }
    function mn(e, t) {
        let r = () => {},
            n = Jt[t.type] || r,
        ...
        Bt(e, t.original, o);
        let s = () => {
            e._x_ignore || e._x_ignoreSelf || (n.inline && n.inline(e, t, i), (n = n.bind(n, e, t, i)), ft ? ne.get(er).push(n) : n());
        };
    ...
    var dt = "DEFAULT",
        Ae = ["ignore", "ref", "data", "id", "bind", "init", "for", "mask", "model", "modelable", "transition", "show", "if", dt, "teleport", "element"];
    function _n(e, t) {
        let r = Ae.indexOf(e.type) === -1 ? dt : e.type,
            n = Ae.indexOf(t.type) === -1 ? dt : t.type;
    ...
    function sr() {
        document.body || O("Unable to initialize. Trying to load Alpine before `<body>` is available. Did you forget to add `defer` in Alpine's `<script>` tag?"),
            B(document, "alpine:init"),
            B(document, "alpine:initializing"),
            rt(),
            jt((t) => w(t, R)),
            _e((t) => gn(t)),
            Kt((t, r) => {
        ...
        let e = (t) => !z(t.parentElement, !0);
        Array.from(document.querySelectorAll(or()))
            .filter(e)
            .forEach((t) => {
                w(t);
            }),
            B(document, "alpine:initialized");
    }
    var ht = [],
        ar = [];
    function cr() {
    ...
    function ie(e, t) {
        return Array.isArray(t) ? ur(e, t.join(" ")) : typeof t == "object" && t !== null ? xn(e, t) : typeof t == "function" ? ie(e, t()) : ur(e, t);
    }
    function ur(e, t) {
    ...
    function En(e, t, r) {
        ...
        let s = !t.includes("opacity") && !t.includes("scale"),
            ...
            M = "opacity, transform",
            W = se(t, "duration", 150) / 1e3,
            pe = se(t, "duration", 75) / 1e3,
            f = "cubic-bezier(0.4, 0.0, 0.2, 1)";
        i &&
            ((e._x_transition.enter.during = { transformOrigin: y, transitionDelay: p, transitionProperty: M, transitionDuration: `${W}s`, transitionTimingFunction: f }),
            (e._x_transition.enter.start = { opacity: l, transform: `scale(${u})` }),
            (e._x_transition.enter.end = { opacity: 1, transform: "scale(1)" })),
            o &&
                ((e._x_transition.leave.during = { transformOrigin: y, transitionDelay: p, transitionProperty: M, transitionDuration: `${pe}s`, transitionTimingFunction: f }),
    ...
    function Me(e, t, { during: r, start: n, end: i } = {}, o = () => {}, s = () => {}) {
    ...
    function ae(e, t, r, n = []) {
        switch ((e._x_bindings || (e._x_bindings = A({})), (e._x_bindings[t] = r), (t = n.includes("camel") ? kn(t) : t), t)) {
            case "value":
                Tn(e, r);
                break;
            case "style":
    ...
    function Tn(e, t) {
        if (e.type === "radio") e.attributes.value === void 0 && (e.value = t), window.fromModel && (e.checked = mr(e.value, t));
            ...
            Number.isInteger(t)
                ...
                : (e.checked = !!t);
        else if (e.tagName === "SELECT") Nn(e, t);
        else {
            if (e.value === t) return;
            e.value = t;
        }
    ...
    function Mn(e, t, r) {
        [null, void 0, !1].includes(r) && In(t) ? e.removeAttribute(t) : (hr(t) && (r = t), Pn(e, t, r));
    }
    function Pn(e, t, r) {
    ...
    var H = {},
        xr = !1;
    function yr(e, t) {
        if ((xr || ((H = A(H)), (xr = !0)), t === void 0)) return H[e];
        (H[e] = t), typeof t == "object" && t !== null && t.hasOwnProperty("init") && typeof t.init == "function" && H[e].init(), ye(H[e]);
    }
    function br() {
        return H;
    }
    ...
    var Dn = {
            ...
            disableEffectScheduling: Pt,
            setReactivityEngine: It,
            closestDataStack: N,
            skipDuringClone: D,
            addRootSelector: Ce,
            addInitSelector: Re,
    ...
    var ns = gt($n + ",async,autofocus,autoplay,controls,default,defer,disabled,hidden,loop,open,required,reversed,scoped,seamless,checked,muted,multiple,selected");
    var Tr = {};
    var xt = Object.assign;
    var Ln = Object.prototype.hasOwnProperty,
        ce = (e, t) => Ln.call(e, t),
        $ = Array.isArray,
        le = (e) => Cr(e) === "[object Map]";
    ...
    var De = (e) => {
        ...
        Kn = /-(\w)/g,
        is = De((e) => e.replace(Kn, (t, r) => (r ? r.toUpperCase() : ""))),
        Bn = /\B([A-Z])/g,
        os = De((e) => e.replace(Bn, "-$1").toLowerCase()),
        zn = De((e) => e.charAt(0).toUpperCase() + e.slice(1)),
        ss = De((e) => (e ? `on${zn(e)}` : "")),
        yt = (e, t) => e !== t && (e === e || t === t);
    var bt = new WeakMap(),
        fe = [],
    ...
    function Hn(e, t) {
        let r = function () {
            ...
            if (!fe.includes(r)) {
                kr(r);
                try {
                    return Un(), fe.push(r), (q = r), e();
                } finally {
                    fe.pop(), Pr(), (q = fe[fe.length - 1]);
                }
            }
        };
    ...
    function T(e, t, r) {
        if (!X || q === void 0) return;
        let n = bt.get(e);
        n || bt.set(e, (n = new Map()));
        let i = n.get(r);
        i || n.set(r, (i = new Set())), i.has(q) || (i.add(q), q.deps.push(i));
    }
    function L(e, t, r, n, i, o) {
        ...
        if (t === "clear") s.forEach(c);
            ...
            switch ((r !== void 0 && c(s.get(r)), t)) {
                case "add":
                    $(e) ? Ie(r) && c(s.get("length")) : (c(s.get(U)), le(e) && c(s.get(vt)));
                    break;
                case "delete":
                    $(e) || (c(s.get(U)), le(e) && c(s.get(vt)));
                    break;
                case "set":
                    le(e) && c(s.get(U));
                    break;
    ...
    var Gn = gt("__proto__,__v_isRef,__isVue"),
        Ir = new Set(
    ...
    function $e(e = !1, t = !1) {
        return function (n, i, o) {
            ...
            if (i === "__v_raw" && o === (e ? (t ? ei : $r) : t ? Xn : Dr).get(n)) return n;
            let s = $(n);
            if (!e && s && ce(Le, i)) return Reflect.get(Le, i, o);
            let a = Reflect.get(n, i, o);
            return (Pe(i) ? Ir.has(i) : Gn(i)) || (e || T(n, "get", i), t) ? a : Et(a) ? (!s || !Ie(i) ? a.value : a) : ue(a) ? (e ? Lr(a) : Fe(a)) : a;
        };
    }
    var ti = Fr(),
        ri = Fr(!0);
    function Fr(e = !1) {
        return function (r, n, i, o) {
            let s = r[n];
            if (!e && ((i = g(i)), (s = g(s)), !$(r) && Et(s) && !Et(i))) return (s.value = i), !0;
            let a = $(r) && Ie(n) ? Number(n) < r.length : ce(r, n),
                c = Reflect.set(r, n, i, o);
            return r === g(o) && (a ? yt(i, s) && L(r, "set", n, i, s) : L(r, "add", n, i)), c;
        };
    }
    function ni(e, t) {
        let r = ce(e, t),
        ...
        return i && r && L(e, "delete", t, void 0, n), i;
    }
    function ii(e, t) {
    ...
    function oi(e) {
        return T(e, "iterate", $(e) ? "length" : U), Reflect.ownKeys(e);
    }
    var jr = { get: Yn, set: ti, deleteProperty: ni, has: ii, ownKeys: oi },
        Kr = {
            get: Zn,
            set(e, t) {
                return !0;
    ...
    function ze(e, t = !1) {
        return (e = e.__v_raw), !t && T(g(e), "iterate", U), Reflect.get(e, "size", e);
    }
    function Br(e) {
        e = g(e);
        let t = g(this);
        return je(t).has.call(t, e) || (t.add(e), L(t, "add", e, e)), this;
    }
    function zr(e, t) {
        t = g(t);
        let r = g(this),
            { has: n, get: i } = je(r),
            o = n.call(r, e);
        o || ((e = g(e)), (o = n.call(r, e)));
        let s = i.call(r, e);
        return r.set(e, t), o ? yt(t, s) && L(r, "set", e, t, s) : L(r, "add", e, t), this;
    }
    function Vr(e) {
        let t = g(this),
            { has: r, get: n } = je(t),
            i = r.call(t, e);
        i || ((e = g(e)), (i = r.call(t, e)));
        let o = n ? n.call(t, e) : void 0,
            s = t.delete(e);
        return i && L(t, "delete", e, void 0, o), s;
    }
    function Hr() {
        let e = g(this),
            t = e.size !== 0,
            r = void 0,
            n = e.clear();
        return t && L(e, "clear", void 0, void 0, r), n;
    }
    function Ve(e, t) {
        return function (n, i) {
            let o = this,
    ...
    si.forEach((e) => {
        (qr[e] = He(e, !1, !1)), (Wr[e] = He(e, !0, !1)), (Ur[e] = He(e, !1, !0)), (Gr[e] = He(e, !0, !0));
    });
    function qe(e, t) {
        let r = t ? (e ? Gr : Ur) : e ? Wr : qr;
        return (n, i, o) => (i === "__v_isReactive" ? !e : i === "__v_isReadonly" ? e : i === "__v_raw" ? n : Reflect.get(ce(r, i) && i in n ? r : n, i, o));
    }
    var ai = { get: qe(!1, !1) },
        hs = { get: qe(!1, !0) },
        ci = { get: qe(!0, !1) },
    ...
    function ui(e) {
        return e.__v_skip || !Object.isExtensible(e) ? 0 : li(Rr(e));
    }
    function Fe(e) {
        return e && e.__v_isReadonly ? e : Yr(e, !1, jr, ai, Dr);
    }
    function Lr(e) {
        return Yr(e, !0, Kr, ci, $r);
    }
    ...
    x("data", (e) => xe(e));
    x("root", (e) => z(e));
    x("refs", (e) => (e._x_refs_proxy || (e._x_refs_proxy = P(fi(e))), e._x_refs_proxy));
    function fi(e) {
        let t = [],
            r = e;
    ...
    d("ignore", Xr);
    d("effect", (e, { expression: t }, { effect: r }) => r(_(e, t)));
    function de(e, t, r, n) {
        let i = e,
            o = (c) => n(c),
            s = {},
    ...
    function hi(e, t) {
        ...
        return (r = r.filter((o) => !i.includes(o))), !(i.length > 0 && i.filter((s) => ((s === "cmd" || s === "super") && (s = "meta"), e[`${s}Key`])).length === i.length && en(e.key).includes(r[0]));
    }
    function en(e) {
        if (!e) return [];
        e = _i(e);
    ...
    d("model", (e, { modifiers: t, expression: r }, { effect: n, cleanup: i }) => {
        ...
        (e._x_model = {
            ...
            (e._x_forceModelUpdate = () => {
                o((y) => {
                    y === void 0 && r.match(/\./) && (y = ""), (window.fromModel = !0), m(() => ae(e, "value", y)), delete window.fromModel;
                });
            }),
            n(() => {
                ...
                m(() => {
                    ...
                    if (e.type === "checkbox")
                        if (Array.isArray(i)) {
                            ...
                            return n.target.checked ? i.concat([o]) : i.filter((s) => !xi(s, o));
    ...
    d("bind", (e, { value: t, modifiers: r, expression: n, original: i }, { effect: o }) => {
        if (!t) return bi(e, n, i, o);
        if (t === "key") return vi(e, n);
        let s = _(e, n);
        o(() =>
            s((a) => {
                a === void 0 && n.match(/\./) && (a = ""), m(() => ae(e, t, a, r));
            })
        );
    });
    function bi(e, t, r, n) {
    ...
    d("for", (e, { expression: t }, { effect: r, cleanup: n }) => {
        let i = Ei(t),
            o = _(e, i.items),
            s = _(e, e._x_keyExpression || "index");
        (e._x_prevKeys = []),
            (e._x_lookup = {}),
            r(() => wi(e, i, o, s)),
            n(() => {
    ...
    function wi(e, t, r, n) {
        let i = (s) => typeof s == "object" && !Array.isArray(s),
            o = e;
        r((s) => {
            Si(s) && s >= 0 && (s = Array.from(Array(s).keys(), (f) => f + 1)), s === void 0 && (s = []);
            let a = e._x_lookup,
                c = e._x_prevKeys,
                l = [],
                u = [];
    ...
    I.setEvaluator(ct);
    I.setReactivityEngine({ reactive: Fe, effect: Mr, release: Nr, raw: g });
    var kt = I;
    window.Alpine = kt;
    queueMicrotask(() => {
        kt.start();
